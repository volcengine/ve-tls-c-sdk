...
void ve_tls_producer_config_apply_runtime_defaults(ve_tls_config * config) {
    ...
    int32_t derived_log_bytes = ve_tls_runtime_default_package_bytes(config->max_buffer_bytes);
    ...
    int32_t derived_threads = ve_tls_runtime_default_thread_count(config->max_buffer_bytes);
